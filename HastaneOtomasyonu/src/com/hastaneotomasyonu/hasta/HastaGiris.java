...
public class HastaGiris extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        UstPanelLayout.setHorizontalGroup(
            ...
            .addGroup(UstPanelLayout.createSequentialGroup()
                .addComponent(Logo)
                .addGap(18, 18, 18)
                .addComponent(EkranAdi, javax.swing.GroupLayout.PREFERRED_SIZE, 217, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, AltPanelLayout.createSequentialGroup()
                ...
                .addGroup(AltPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, AltPanelLayout.createSequentialGroup()
                        ...
                        .addGap(127, 127, 127))))
            .addGroup(AltPanelLayout.createSequentialGroup()
                .addComponent(SifreAlmaTusu, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
        AltPanelLayout.setVerticalGroup(
            ...
            .addGroup(AltPanelLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(SifreAlmaTusu, javax.swing.GroupLayout.DEFAULT_SIZE, 28, Short.MAX_VALUE))
        );

        getContentPane().add(AltPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 440, 270));
    ...
    private void GirisTusuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GirisTusuActionPerformed
        ...
        boolean giris = hastaIslemleri.girisYap(TCAlani.getText(), hashPassword(new String(SifreAlani.getPassword())));
        if(giris){
